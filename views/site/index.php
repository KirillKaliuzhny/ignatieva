...
<div class="container mt-4">
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <p class="lead">Приглашаем принять участие студентов РГУПС в конкурсе компьютерной графики и дизайна!</p>
            <ol class="list-unstyled">
                ...
                <li class="mb-2">1.2 Жюри конкурса формируется Оргкомитетом фестиваля из числа экспертов, преподавателей
                ...
                <li class="mb-2">1.4 Участники должны подать заявку на сайте конкурса (Прием заявок) до 15 апреля 2025
                    года (включительно).
                </li>
